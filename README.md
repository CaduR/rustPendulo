...
Este é o meu primeiro projeto desenvolvido em Rust. O objetivo foi criar uma simulação de um pêndulo utilizando a biblioteca de gráficos 2D Speedy2d, explorando os fundamentos da linguagem e conceitos de cinemática.
